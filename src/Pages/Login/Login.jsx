        ...
        try {
            ...
            if (data.user) {
                ...
                try {
                    ...
                    if (roleError) {
                        toast.error(`Could not verify role: ${roleError.message}`);
                        navigate('/Home');
                    ...
                    console.error("Error checking role on login:", roleErr);
                    toast.error(`Role check exception: ${roleErr.message}`);
                    navigate('/Home');
                }
            }
        } catch (err) {
                        ...
                        <form className='loginForm' onSubmit={handleSubmit}>
                            ...
                            <div className="loginInputs">
                                ...
                                <div className="loginBox">
                                    ...
                                    {showPassword ? (
                                        <FaEyeSlash className='loginIcon' onClick={() => setShowPassword(false)} />
                                    ) : (
